...
_WORDSTATE = _descriptor.EnumDescriptor(
  ...
  values=[
    _descriptor.EnumValueDescriptor(
      name='WORDSTATE_PENDING', index=0, number=0,
      serialized_options=None,
      type=None,
      create_key=_descriptor._internal_create_key),
    _descriptor.EnumValueDescriptor(
...
_SOUNDIDCLASS = _descriptor.EnumDescriptor(
  name='SoundIdClass',
  full_name='sensory.api.v1.audio.SoundIdClass',
  filename=None,
  file=DESCRIPTOR,
  create_key=_descriptor._internal_create_key,
  values=[
    _descriptor.EnumValueDescriptor(
      ...
      create_key=_descriptor._internal_create_key),
    _descriptor.EnumValueDescriptor(
      name='ANIMALS', index=1, number=1,
      serialized_options=None,
      type=None,
      create_key=_descriptor._internal_create_key),
    _descriptor.EnumValueDescriptor(
      name='AUTOMOTIVE', index=2, number=2,
      serialized_options=None,
      type=None,
      create_key=_descriptor._internal_create_key),
    _descriptor.EnumValueDescriptor(
      name='BABY_MONITOR', index=3, number=3,
      serialized_options=None,
      type=None,
      create_key=_descriptor._internal_create_key),
    _descriptor.EnumValueDescriptor(
      name='COMBAT', index=4, number=4,
      serialized_options=None,
      type=None,
      create_key=_descriptor._internal_create_key),
    _descriptor.EnumValueDescriptor(
      name='EMERGENCY_SERVICES', index=5, number=5,
      serialized_options=None,
      type=None,
      create_key=_descriptor._internal_create_key),
    _descriptor.EnumValueDescriptor(
      name='HEARING_IMPAIRED_INSIDE', index=6, number=6,
      serialized_options=None,
      type=None,
      create_key=_descriptor._internal_create_key),
    _descriptor.EnumValueDescriptor(
      name='HEARING_IMPAIRED_OUTSIDE', index=7, number=7,
      serialized_options=None,
      type=None,
      create_key=_descriptor._internal_create_key),
    _descriptor.EnumValueDescriptor(
      name='HOME_ALERTS', index=8, number=8,
      serialized_options=None,
      type=None,
      create_key=_descriptor._internal_create_key),
    _descriptor.EnumValueDescriptor(
      name='INDUSTRIAL_ALERTS', index=9, number=9,
      serialized_options=None,
      type=None,
      create_key=_descriptor._internal_create_key),
    _descriptor.EnumValueDescriptor(
      name='INSTRUMENTS', index=10, number=10,
      serialized_options=None,
      type=None,
      create_key=_descriptor._internal_create_key),
    _descriptor.EnumValueDescriptor(
      name='MUSIC_GENRES', index=11, number=11,
      serialized_options=None,
      type=None,
      create_key=_descriptor._internal_create_key),
    _descriptor.EnumValueDescriptor(
      name='SPORTS', index=12, number=12,
      serialized_options=None,
      type=None,
      create_key=_descriptor._internal_create_key),
    _descriptor.EnumValueDescriptor(
      name='TOP_40', index=13, number=13,
      serialized_options=None,
      type=None,
      create_key=_descriptor._internal_create_key),
  ],
...
_sym_db.RegisterEnumDescriptor(_SOUNDIDCLASS)

SoundIdClass = enum_type_wrapper.EnumTypeWrapper(_SOUNDIDCLASS)
NOT_SET = 0
FLUSH = 1
RESET = 2
FINAL = 3
...
_CREATEENROLLMENTRESPONSE = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='enrollmentToken', full_name='sensory.api.v1.audio.CreateEnrollmentResponse.enrollmentToken', index=7,
...
_SOUNDIDTOPNRESPONSE = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='resultId', full_name='sensory.api.v1.audio.SoundIdTopNResponse.resultId', index=0,
      number=1, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=b"".decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='logitScore', full_name='sensory.api.v1.audio.SoundIdTopNResponse.logitScore', index=1,
      number=2, type=2, cpp_type=6, label=1,
      has_default_value=False, default_value=float(0),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='probabilityScore', full_name='sensory.api.v1.audio.SoundIdTopNResponse.probabilityScore', index=2,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='success', full_name='sensory.api.v1.audio.SoundIdTopNResponse.success', index=3,
...
_TRANSCRIBEWORD = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='begintimeMs', full_name='sensory.api.v1.audio.TranscribeWord.begintimeMs', index=0,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='endtimeMs', full_name='sensory.api.v1.audio.TranscribeWord.endtimeMs', index=1,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='confidence', full_name='sensory.api.v1.audio.TranscribeWord.confidence', index=2,
      number=3, type=2, cpp_type=6, label=1,
      has_default_value=False, default_value=float(0),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='wordState', full_name='sensory.api.v1.audio.TranscribeWord.wordState', index=3,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='wordIndex', full_name='sensory.api.v1.audio.TranscribeWord.wordIndex', index=4,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='word', full_name='sensory.api.v1.audio.TranscribeWord.word', index=5,
      number=6, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=b"".decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_TRANSCRIBEWORDRESPONSE = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='words', full_name='sensory.api.v1.audio.TranscribeWordResponse.words', index=0,
      number=1, type=11, cpp_type=10, label=3,
      has_default_value=False, default_value=[],
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='firstWordIndex', full_name='sensory.api.v1.audio.TranscribeWordResponse.firstWordIndex', index=1,
      number=2, type=4, cpp_type=4, label=1,
      has_default_value=False, default_value=0,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='lastWordIndex', full_name='sensory.api.v1.audio.TranscribeWordResponse.lastWordIndex', index=2,
...
_TRANSCRIBERESPONSE = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='wordList', full_name='sensory.api.v1.audio.TranscribeResponse.wordList', index=1,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='hasVoiceActivity', full_name='sensory.api.v1.audio.TranscribeResponse.hasVoiceActivity', index=2,
...
_CREATEENROLLMENTCONFIG = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      name='disableServerEnrollmentTemplateStorage', full_name='sensory.api.v1.audio.CreateEnrollmentConfig.disableServerEnrollmentTemplateStorage', index=9,
...
_AUTHENTICATECONFIG = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='enrollmentToken', full_name='sensory.api.v1.audio.AuthenticateConfig.enrollmentToken', index=7,
...
_VALIDATEEVENTCONFIG = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='clearBufferAtEndOfUtterance', full_name='sensory.api.v1.audio.ValidateEventConfig.clearBufferAtEndOfUtterance', index=5,
      number=6, type=8, cpp_type=7, label=1,
      has_default_value=False, default_value=False,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='soundIdClass', full_name='sensory.api.v1.audio.ValidateEventConfig.soundIdClass', index=6,
      number=7, type=14, cpp_type=8, label=1,
      has_default_value=False, default_value=0,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_VALIDATEENROLLEDEVENTCONFIG = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=b'\372B\005\202\001\002\020\001', file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='enrollmentToken', full_name='sensory.api.v1.audio.ValidateEnrolledEventConfig.enrollmentToken', index=4,
...
_CUSTOMVOCABULARYWORDS = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='words', full_name='sensory.api.v1.audio.CustomVocabularyWords.words', index=0,
...
_TRANSCRIBEEVENTCONFIG = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='modelName', full_name='sensory.api.v1.audio.TranscribeEventConfig.modelName', index=0,
      number=1, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=b"".decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=b'\372B\007r\005\020\001\030\377\001', file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='sensitivity', full_name='sensory.api.v1.audio.TranscribeEventConfig.sensitivity', index=1,
      number=2, type=14, cpp_type=8, label=1,
      has_default_value=False, default_value=0,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_TRANSCRIBECONFIG = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=b'\372B\006r\004\020\001\030\177', file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='enablePunctuationCapitalization', full_name='sensory.api.v1.audio.TranscribeConfig.enablePunctuationCapitalization', index=3,
      number=4, type=8, cpp_type=7, label=1,
      has_default_value=False, default_value=False,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='doSingleUtterance', full_name='sensory.api.v1.audio.TranscribeConfig.doSingleUtterance', index=4,
      number=5, type=8, cpp_type=7, label=1,
      has_default_value=False, default_value=False,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='vadSensitivity', full_name='sensory.api.v1.audio.TranscribeConfig.vadSensitivity', index=5,
      number=6, type=14, cpp_type=8, label=1,
      has_default_value=False, default_value=0,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='vadDuration', full_name='sensory.api.v1.audio.TranscribeConfig.vadDuration', index=6,
      number=7, type=2, cpp_type=6, label=1,
      has_default_value=False, default_value=float(0),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='customVocabRewardThreshold', full_name='sensory.api.v1.audio.TranscribeConfig.customVocabRewardThreshold', index=7,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='customVocabularyId', full_name='sensory.api.v1.audio.TranscribeConfig.customVocabularyId', index=8,
      number=9, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=b"".decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_VOICESYNTHESISCONFIG = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='modelName', full_name='sensory.api.v1.audio.VoiceSynthesisConfig.modelName', index=0,
      number=2, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=b"".decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=b'\372B\007r\005\020\001\030\377\001', file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='sampleRateHertz', full_name='sensory.api.v1.audio.VoiceSynthesisConfig.sampleRateHertz', index=1,
      number=3, type=5, cpp_type=1, label=1,
      has_default_value=False, default_value=0,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=b'\372B\t\032\007\030\200\356\005(\300>', file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
  ],
  extensions=[
  ],
  nested_types=[],
...
_VALIDATEEVENTRESPONSE.fields_by_name['topNResponse'].message_type = _SOUNDIDTOPNRESPONSE
_VALIDATEEVENTRESPONSE.fields_by_name['postProcessingAction'].message_type = _AUDIORESPONSEPOSTPROCESSINGACTION
_TRANSCRIBEWORD.fields_by_name['wordState'].enum_type = _WORDSTATE
_TRANSCRIBEWORDRESPONSE.fields_by_name['words'].message_type = _TRANSCRIBEWORD
_TRANSCRIBERESPONSE.fields_by_name['wordList'].message_type = _TRANSCRIBEWORDRESPONSE
...
_VALIDATEEVENTCONFIG.fields_by_name['soundIdClass'].enum_type = _SOUNDIDCLASS
...
_TRANSCRIBEEVENTCONFIG.fields_by_name['sensitivity'].enum_type = _THRESHOLDSENSITIVITY
_TRANSCRIBECONFIG.fields_by_name['audio'].message_type = _AUDIOCONFIG
_TRANSCRIBECONFIG.fields_by_name['vadSensitivity'].enum_type = _THRESHOLDSENSITIVITY
_TRANSCRIBECONFIG.fields_by_name['customVocabRewardThreshold'].enum_type = _THRESHOLDSENSITIVITY
_TRANSCRIBECONFIG.fields_by_name['customWordList'].message_type = _CUSTOMVOCABULARYWORDS
_TRANSCRIBECONFIG.fields_by_name['wakeWordConfig'].message_type = _TRANSCRIBEEVENTCONFIG
...
DESCRIPTOR.message_types_by_name['SoundIdTopNResponse'] = _SOUNDIDTOPNRESPONSE
...
DESCRIPTOR.message_types_by_name['TranscribeWord'] = _TRANSCRIBEWORD
DESCRIPTOR.message_types_by_name['TranscribeWordResponse'] = _TRANSCRIBEWORDRESPONSE
...
DESCRIPTOR.message_types_by_name['CustomVocabularyWords'] = _CUSTOMVOCABULARYWORDS
DESCRIPTOR.message_types_by_name['TranscribeEventConfig'] = _TRANSCRIBEEVENTCONFIG
...
DESCRIPTOR.enum_types_by_name['WordState'] = _WORDSTATE
DESCRIPTOR.enum_types_by_name['ThresholdSensitivity'] = _THRESHOLDSENSITIVITY
DESCRIPTOR.enum_types_by_name['SoundIdClass'] = _SOUNDIDCLASS
...
SoundIdTopNResponse = _reflection.GeneratedProtocolMessageType('SoundIdTopNResponse', (_message.Message,), {
  'DESCRIPTOR' : _SOUNDIDTOPNRESPONSE,
  '__module__' : 'v1.audio.audio_pb2'
  # @@protoc_insertion_point(class_scope:sensory.api.v1.audio.SoundIdTopNResponse)
  })
_sym_db.RegisterMessage(SoundIdTopNResponse)
...
TranscribeWord = _reflection.GeneratedProtocolMessageType('TranscribeWord', (_message.Message,), {
  'DESCRIPTOR' : _TRANSCRIBEWORD,
  '__module__' : 'v1.audio.audio_pb2'
  # @@protoc_insertion_point(class_scope:sensory.api.v1.audio.TranscribeWord)
  })
_sym_db.RegisterMessage(TranscribeWord)

TranscribeWordResponse = _reflection.GeneratedProtocolMessageType('TranscribeWordResponse', (_message.Message,), {
  'DESCRIPTOR' : _TRANSCRIBEWORDRESPONSE,
  '__module__' : 'v1.audio.audio_pb2'
  # @@protoc_insertion_point(class_scope:sensory.api.v1.audio.TranscribeWordResponse)
  })
_sym_db.RegisterMessage(TranscribeWordResponse)
...
CustomVocabularyWords = _reflection.GeneratedProtocolMessageType('CustomVocabularyWords', (_message.Message,), {
  'DESCRIPTOR' : _CUSTOMVOCABULARYWORDS,
  '__module__' : 'v1.audio.audio_pb2'
  # @@protoc_insertion_point(class_scope:sensory.api.v1.audio.CustomVocabularyWords)
  })
_sym_db.RegisterMessage(CustomVocabularyWords)

TranscribeEventConfig = _reflection.GeneratedProtocolMessageType('TranscribeEventConfig', (_message.Message,), {
  'DESCRIPTOR' : _TRANSCRIBEEVENTCONFIG,
  '__module__' : 'v1.audio.audio_pb2'
  # @@protoc_insertion_point(class_scope:sensory.api.v1.audio.TranscribeEventConfig)
  })
_sym_db.RegisterMessage(TranscribeEventConfig)
...
_VALIDATEEVENTCONFIG.fields_by_name['soundIdClass']._options = None
...
_CUSTOMVOCABULARYWORDS.fields_by_name['words']._options = None
_TRANSCRIBEEVENTCONFIG.fields_by_name['modelName']._options = None
_TRANSCRIBEEVENTCONFIG.fields_by_name['sensitivity']._options = None
...
_VOICESYNTHESISCONFIG.fields_by_name['modelName']._options = None
_VOICESYNTHESISCONFIG.fields_by_name['sampleRateHertz']._options = None
