...
def set_client_credentials(environment_config: dict) -> None:
    ...
    environment_config['client_secret'] = CryptoService().get_secure_random_string(length=24)
...
def save_environment_config(environment_config: dict) -> None:
    ...
    need to be saved to the configuration file so they can be accessed in the other
    example files.
